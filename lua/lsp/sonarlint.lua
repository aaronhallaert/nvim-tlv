...
local sonarlint_url = 'https://github.com/SonarSource/sonarlint-vscode/releases/download/4.7.0%2B76532/sonarlint-vscode-4.7.0.vsix'
...
local download = function()
  ...
  if vim.fn.filereadable(app_location .. '/sonarlint/extension/server/sonarlint-ls.jar') == 0 then
    ...
    vim.fn.system('curl -L ' .. sonarlint_url .. ' --output ' .. app_location .. '/sonarlint/sonarlint-ls.vsix')
    vim.print 'Unzipping Sonarlint VSCode 4.7.0 ...'
    vim.fn.system('unzip ' .. app_location .. '/sonarlint/sonarlint-ls.vsix -d ' .. app_location .. '/sonarlint')
